        ...
        plugins: [
            ...
            VitePWA({
                ...
                manifest: {
                    ...
                    icons: [
                        {
                            src: "/images/icon/unlil-48.png",
                            sizes: "48x48",
                            type: "image/png",
                        },
                        {
                            src: "/images/icon/unlil-72.png",
                            sizes: "72x72",
                            type: "image/png",
                        },
                        {
                            src: "/images/icon/unlil-96.png",
                            sizes: "96x96",
                            type: "image/png",
                        },
                        {
                            src: "/images/icon/unlil-128.png",
                            sizes: "128x128",
                            type: "image/png",
                        },
                        {
                            src: "/images/icon/unlil-144.png",
                            sizes: "144x144",
                            type: "image/png",
                        },
                        {
                            src: "/images/icon/unlil-192.png",
                            sizes: "192x192",
                            type: "image/png",
                        },
                        {
                            src: "/images/icon/unlil-512.png",
                            sizes: "512x512",
                            type: "image/png",
                        },
                    ],
